...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessAPI.AlphabeticalListOfProduct", b =>
                {
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessAPI.Entities.CategorySalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("BusinessAPI.Entities.CurrentProductList", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("BusinessAPI.Entities.CustomerAndSuppliersByCity", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.CustomerDemographic", b =>
                {
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Employee", b =>
                {
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Invoice", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessAPI.Entities.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.OrderDetailsExtended", b =>
                {
                    b.Property<float>("Discount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.OrderSubtotal", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.OrdersQry", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.ProductSalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("BusinessAPI.Entities.ProductsAboveAveragePrice", b =>
                {
                    b.Property<string>("ProductName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("BusinessAPI.Entities.ProductsByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("BusinessAPI.Entities.QuarterlyOrder", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Region", b =>
                {
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.SalesByCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("CategoryID");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.SalesTotalsByAmount", b =>
                {
                    b.Property<string>("CompanyName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Shipper", b =>
                {
            ...
            modelBuilder.Entity("BusinessAPI.Entities.SummaryOfSalesByQuarter", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.SummaryOfSalesByYear", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Territory", b =>
                {
            ...
            modelBuilder.Entity("BusinessAPI.Entities.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Employee", b =>
                {
                    b.HasOne("BusinessAPI.Entities.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Order", b =>
                {
                    b.HasOne("BusinessAPI.Entities.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("BusinessAPI.Entities.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("BusinessAPI.Entities.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("BusinessAPI.Entities.OrderDetail", b =>
                {
                    b.HasOne("BusinessAPI.Entities.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .IsRequired()
                        .HasConstraintName("FK_Order_Details_Orders");

                    b.HasOne("BusinessAPI.Entities.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Product", b =>
                {
                    b.HasOne("BusinessAPI.Entities.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("BusinessAPI.Entities.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("BusinessAPI.Entities.Territory", b =>
                {
                    b.HasOne("BusinessAPI.Entities.Region", "Region")
            ...
            modelBuilder.Entity("BusinessAPI.Entities.UserRole", b =>
                {
                    b.HasOne("BusinessAPI.Entities.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BusinessAPI.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("CustomerCustomerDemo", b =>
                {
                    b.HasOne("BusinessAPI.Entities.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers");

                    b.HasOne("BusinessAPI.Entities.CustomerDemographic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    b.HasOne("BusinessAPI.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("BusinessAPI.Entities.Territory", null)
                        .WithMany()
